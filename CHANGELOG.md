...
- *(maintenance)* Обновлен project-tree
...
- *(NC)* Добавлено получение стеков из доски
    #12

- *(NC)* Добавлена модель для стека
    #12

- *(Bot)* Добавлен обработчик команды выбора получения стеков по определенной доске
    #12


### 🐛 Исправления

- *(settings)* Актуализирована версия

- *(NC)* Исправление endpoint для досок и стеков


### 🚜 Рефакторинг

- *(Bot)* Рефкторинг роутов команд бота
